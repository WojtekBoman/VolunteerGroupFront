...
const Event = (props) => {
        ...
        const width = (props.liczbaPrzypisanychWolontariuszy / props.liczbaPotrzebnychWolontariuszy) * 100 + "%";
        ...
        return(
            <div class="jumbotron">
                    ...
                    <p class="lead">Liczba wolontariuszy <span>{props.liczbaPrzypisanychWolontariuszy}</span> / <span>{props.liczbaPotrzebnychWolontariuszy}</span></p>
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="4"
                        aria-valuemin="0" aria-valuemax={props.liczbaPotrzebnychWolontariuszy} style={{width}}>
